...

{
    ...
    {
        //class attributes
        private readonly SortedSet<Property> props = new SortedSet<Property>();
        public SortedSet<Person> residents = new SortedSet<Person>();
        public SortedSet<Residential> residences = new SortedSet<Residential>();
        ...
        public List<Residential> Residences => residences.ToList();
        ...
        public bool AddResidence(Residential residence)
        {
            return residences.Add(residence);
        }
    }
}