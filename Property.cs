...
namespace Assign3
{
    ...
    public abstract class Property : IComparable
    {
        ...
        public string stringParser() => propertiesInput[index++];
        protected bool boolParser() => (stringParser() == "T");
        protected uint uintParser() => uint.Parse(stringParser());
        protected uint binaryParser() => Convert.ToUInt32(stringParser(), 10);
        public Property()
        {
            id = 0;
            ownerID = 0;
        ...
        public Property(string newAddress)
        {
            streetAddr = newAddress;
        }
